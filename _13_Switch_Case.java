...
//VAR CAN BE AN INTEGER, CHARACTER OR STRING IN JAVA;
//SWITCH STATEMENT CAN BE REPLACED WITH ENHANCED SWITCH LAST SECOND CODE IS THE EXAMPLE
       /* Switch(var) {
            Case C1:
            //Code;
            break;
...
//        THIS IS AN EXAMPLE OF ENHANCED SWITCH; HERE WE DON'T HAVE TO USE BREAK OR CONTINUE IT'S A FEATURE OF ENHANCED SWITCH
        /*String var = "Saurabh";
        switch (var) {
            case "Shubham" -> {
